...
var clockwise = function(ring) {
  ...
  return area <= 0;="" };="" var="" contains="function(ring," point)="" {="" x="point[0]," y="point[1]," for="" (var="" i="0," n="ring.length," j="n" -="" 1;="" <="" n;="" pi="ring[i]," xi="pi[0]," yi="pi[1]," pj="ring[j]," xj="pj[0]," yj="pj[1];" if="" (((yi=""> y) ^ (yj > y)) && (x < (xj - xi) * (y - yi) / (yj - yi) + xi)) contains = !contains;
  }
  return contains;
};
